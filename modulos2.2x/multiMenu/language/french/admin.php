...
define("_AD_MULTIMENU_SUBLINK",	"Lien secondaire dynamique");
...
<table><tr><td><img src='../images/attention.png' /></td><td>Pour que les liens dynamiques puissent fonctionner,<br />il est nécessaire de toujours ajouter un ' / ' (slash)<br />à la fin des liens pointants vers un répertoire !</td><tr></table>");
