...
function ShowSended(){
	...
	while ($row=$xoopsDB->fetchArray($result)){
		echo "<tr class='even'><td align='left'>
			...
			<td align='center'><a href='sended.php?op=del&amp;ids=$row[id_send]'>Eliminar</a>
			| <a href='sended.php?op=acept&amp;ids=$row[id_send]'>Aceptar</a></td></tr>";
	}
	echo "</table>";
	xoops_cp_footer();
}
	...
	*/
	...
	echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='outer'>
    		...
    		<th colspan='2'>"._AM_RMDP_ACEPT."</th>
  			...
  			<form name='frmNew' method='post' action='sended.php?op=save'>
  			<tr>
...
function Save(){
	...
	if ($ids<=0){ header('dended.php'); die(); }
