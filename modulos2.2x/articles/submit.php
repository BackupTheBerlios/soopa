<?php
// $Id: submit.php,v 1.1 2005/07/25 15:18:12 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
//  Author: Andrew Mills                                                     //
...
if (!isset($_REQUEST['op'])) {
	...
	$default_ed2 = new XoopsFormDhtmlTextArea(_MD_ART_SUBTART, 'formdata[art_article_text]', '', '30', '37');
	
	// Loads XOOPS' default editor
	if ($xoopsModuleConfig['articleedituser'] == "0") {
		$editordesc = $default_ed1;
		$editormain = $default_ed2;
	} // default
	// Spaw
	if ($xoopsModuleConfig['articleedituser'] == "1") {
		if (is_readable(XOOPS_ROOT_PATH . "/class/spaw/formspaw.php")) {
			include_once XOOPS_ROOT_PATH . "/class/spaw/formspaw.php";
			$editordesc = new XoopsFormSpaw(_MD_ART_SUBDESC, 'formdata[art_description]', '', '100%', '150px');
			$editormain = new XoopsFormSpaw(_MD_ART_SUBTART, 'formdata[art_article_text]', '', "100%", '450px');
		} else {
			$editordesc = $default_ed1;
			$editormain = $default_ed2;
		}
	...
	// fsk
	if ($xoopsModuleConfig['articleedituser'] == "2") {
		if (is_readable(XOOPS_ROOT_PATH . "/class/fckeditor/formfckeditor.php")) {
			...
			$editormain = new XoopsFormFckeditor(_MD_ART_SUBTART, 'formdata[art_article_text]', '', '100%', '550px');
		} else {
			$editordesc = $default_ed1;
			$editormain = $default_ed2;
		}
	...
	// htmlarea
	if ($xoopsModuleConfig['articleedituser'] == "3") {
		if (is_readable(XOOPS_ROOT_PATH . "/class/htmlarea/formhtmlarea.php")) {
			...
			$editormain = new XoopsFormHtmlarea(_MD_ART_SUBTART, 'formdata[art_article_text]', '', '100%', '550px');
		} else {
			$editordesc = $default_ed1;
			$editormain = $default_ed2;
		}
