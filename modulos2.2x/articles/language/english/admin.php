...
define("_AM_ART_TTLGENVLDTDSC",		"articles are waiting to <a href=\"". XOOPS_URL ."/modules/". $xoopsModule->getVar('dirname') ."/admin/validate.php\">be validated</a>.");
...
define("_AM_ART_TTLGENNUMVIEWSDSC",	"total <a href=\"". XOOPS_URL ."/modules/". $xoopsModule->getVar('dirname') ."/admin/arteddel.php\">article</a> views.");
...
define("_AM_ART_TTLGENNUMHIDDNDSC",	"articles are hidden (includes unvalidated <a href=\"". XOOPS_URL ."/modules/". $xoopsModule->getVar('dirname') ."/admin/arteddel.php\">articles</a>).");
