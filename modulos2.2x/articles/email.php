<?php
// $Id: email.php,v 1.1 2005/07/25 15:18:12 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
//  Author: Andrew Mills                                                     //
...
if ($xoopsModuleConfig['allowemailtofriend'] != 1) {
...
$id = $_GET['id'];
	...
	$xoopsOption['template_main'] = 'article_email.html';
	...
	$xoopsTpl->assign('email_allow', $xoopsModuleConfig['allowemailtofriend']); 
...
//print_r($formdata);
	...
	$myrow = $xoopsDB->fetchArray($result);
		...
		$message = preg_replace("/{ARTICLE_URL}/", XOOPS_URL . "/modules/articles/article.php?id=" . $emailsend['id'], $message);
