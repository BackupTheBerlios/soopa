...
Articles is a module written for the XOOPS v2 content management system (CMS). 
...
down was the "Sections" module - I basically disliked the way it worked and not
...
The Articles module requires the following:

  o A web server running PHP version 4.1.0 or later.
  o Xoops 2.0.5 or later (it should work from version 2.0.3, but has not been 
    tested with it.)
...
All original code and content is Copyright © 2003 Andrew Mills. While I have 
...
errata to the Articles code that you make. 
