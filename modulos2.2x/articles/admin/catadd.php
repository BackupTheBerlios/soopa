<?php
// $Id: catadd.php,v 1.1 2005/07/25 15:18:12 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
//  Author: Andrew Mills                                                     //
...
if (isset($_REQUEST['but_save'])) {
	...
	$newid = $xoopsDB->genId($xoopsDB->prefix("articles_cat")."_id_seq");
	$sql = "INSERT INTO ".$xoopsDB->prefix("articles_cat")." VALUES (
		NULL, 
		0, 
		'$cat_name', 
		'$cat_description', 
