<?php
// $Id: functions.php,v 1.1 2005/07/05 12:55:20 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
...
function adminmenu($currentoption = 0, $breadcrumb = '')
{
	...
	echo "<td style=\"width: 60%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;\"><a class=\"nobutton\" href=\"../../system/admin.php?fct=preferences&amp;op=showmod&amp;mod=".$xoopsModule->getVar('mid')."\">" . _AM_NEWS_GENERALSET . "</a> | <a href=\"../index.php\">" . _AM_NEWS_GOTOMOD . "</a> | <a href=\"#\">" . _AM_NEWS_HELP . "</a></td>";
