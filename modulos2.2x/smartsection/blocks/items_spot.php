...
/**
* $Id: items_spot.php,v 1.1 2005/07/05 05:34:13 mauriciodelima Exp $
* Module: SmartSection
...
function b_items_spot_edit($options)
{
	...
	$form .= "<tr><td>"._MB_SS_AUTO_LAST_ITEMS."</td><td>";
	$chk   = "";
	if ($options[0] == 0) {
		$chk = " checked='checked'";
	}
	...
	$form .= "<tr><td>"._MB_SS_LAST_ITEMS_COUNT."</td><td>";
	$form .= "<input type='text' name='options[1]' size='2' value='".$options[1]."' /></td></tr>";
	
	// Select 1 category
	$form .= "<tr><td>"._MB_SS_SELECTCAT."</td><td>";
	$form .= "<select name='options[2]'> " . ss_createCategoryOptions($options[2]) . " /></td></tr>";
	
	// Items Select box
	// Creating the item handler object
	$itemsObj = $smartsection_item_handler->getAllPublished(0, 0);
	...
	$form .= "<tr><td style='vertical-align: top;'>"._MB_SS_SELECT_ITEMS."</td><td>";
	...
	$form .= "<tr><td>"._MB_SS_DISPLAY_WHO_AND_WHEN."</td><td>";
	$chk   = "";
	if ($options[4] == 0) {
		$chk = " checked='checked'";
	}
	...
	// Display Comment(s)
	$form .= "<tr><td>"._MB_SS_DISPLAY_COMMENTS."</td><td>";
	$chk   = "";
	if ($options[5] == 0) {
		$chk = " checked='checked'";
	}
	...
	$form .= "<tr><td style='vertical-align: top;'>"._MB_SS_DISPLAY_TYPE."</td><td>";
	...
	$form .= "<option value='block' ".$sel.">". _MB_SS_DISPLAY_TYPE_BLOCK ."</option>";
	
	$sel = "";
	if ($options[6] == 'bullet') {
		$sel = " selected='selected' ";
	}
	$form .= "<option value='bullet' ".$sel.">". _MB_SS_DISPLAY_TYPE_BULLET ."</option>";
