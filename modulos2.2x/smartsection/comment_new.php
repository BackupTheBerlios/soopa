<?php 
// $Id: comment_new.php,v 1.2 2005/08/02 03:47:51 mauriciodelima Exp $
// ------------------------------------------------------------------------ //
...
if ($com_itemid > 0) {
	...
	$com_replytext = _POSTEDBY.'&nbsp;<b>'.ss_getLinkedUnameFromId($itemObj->uid()) . '</b>&nbsp;'._DATE.'&nbsp;<b>'.$itemObj->dateSub().'</b><br /><br />'.$itemObj->summary();
