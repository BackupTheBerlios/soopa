<?php
// $Id: category.php,v 1.4 2005/07/31 18:23:50 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
...
class NewbbCategoryHandler extends XoopsObjectHandler
{
    ...
    function &getForums($categoryid = 0, $permission = "", $asObject = true)
    {
        $forum_handler = &xoops_getmodulehandler('forum', 'newbb');
        return $forum_handler->getForumsByCategory($categoryid, $permission, $asObject);
    }
