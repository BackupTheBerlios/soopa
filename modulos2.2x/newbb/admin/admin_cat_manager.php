<?php
// $Id: admin_cat_manager.php,v 1.1 2005/07/13 03:55:47 mauriciodelima Exp $
// ------------------------------------------------------------------------ //
...
switch ($op) {
    case "manage":
        ...
        if (count($categories)==0) {
            $xTheme->loadModuleAdminMenu(1, _AM_NEWBB_CREATENEWCATEGORY);
        ...
        $xTheme->loadModuleAdminMenu(1, _AM_NEWBB_CATADMIN);
    ...
    case "mod":
        $fc = &$category_handler->get($cat_id);
        $xTheme->loadModuleAdminMenu(1, _AM_NEWBB_EDITCATEGORY . $fc->getVar('cat_title'));
