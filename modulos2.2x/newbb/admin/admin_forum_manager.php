<?php
// $Id: admin_forum_manager.php,v 1.1 2005/07/13 03:55:47 mauriciodelima Exp $
// ------------------------------------------------------------------------ //
...
switch ($op) {
    ...
    case 'sync':
        $xTheme->loadModuleAdminMenu(5, _AM_NEWBB_SYNCFORUM);
        if (isset($_POST['submit'])) {
            ...
            //$xTheme->loadModuleAdminMenu(3, _AM_NEWBB_SYNCFORUM);
    ...
    case "mod":
        $ff = &$forum_handler->get($forum);
        $xTheme->loadModuleAdminMenu(2, _AM_NEWBB_EDITTHISFORUM . $ff->getVar('forum_name'));
    ...
    case 'manage':
        $xTheme->loadModuleAdminMenu(2, _AM_NEWBB_FORUM_MANAGER);
    ...
    case "default":
    default:
        $xTheme->loadModuleAdminMenu(2, _AM_NEWBB_CREATENEWFORUM);
