...
define("_AM_NEWBB_CAT_ACCESS","访问权限");
...
define("_AM_NEWBB_PERM_TEMPLATE","缺省权限模板");
define("_AM_NEWBB_PERM_TEMPLATE_DESC","可以直接应用到某个/些论坛");
...
define("_AM_NEWBB_PERM_ACTION","权限操作");
