...
define("_ALBM_MYALBUM_DESC","Cria uma sessão de fotos onde usuários podem pesquisar, incluir ou votar em várias fotos.");
...
define( "_ALBM_CFG_ADDPOSTS" , "O Número adicionado pelo usuário quando incluir uma foto." ) ;
