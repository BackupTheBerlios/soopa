...
define("_MI_RMLIB_BNAME1", "Seções");

define("_MI_RMLIB_XOOPSCODE", "Permitir XCode");
define("_MI_RMLIB_XOOPSCODEDESC", "Ativa ou desativa o uso de XCode no conteúdo dos livros.<br>Se desativar esta opção só poderá utilizar HTML.<br>Se activar poderá utilizar ambos.");
define("_MI_RMLIB_LIBNAME", "Nome da Biblioteca");
?>
