<?php
// $Id: module.php,v 1.1 2005/08/02 18:46:11 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
...
class XoopsModule extends XoopsObject
{
    ...
    */
    function install($admingroups = array(), $accessgroups = array()) {
        ...
        $this->executeScript('onInstall', 1);
        ...
        if ($error == false) {
            ...
            $ret .= '<br />'.sprintf(_MD_AM_FAILINS, '<b>'.$this->getVar('dirname').'</b>').'&nbsp;'._MD_AM_ERRORSC.'</p>';
            return $ret;
        }
    }
