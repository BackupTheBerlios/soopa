<?php
// $Id: user.php,v 1.3 2005/08/08 23:44:48 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
...
class XoopsUser extends XoopsObject
{
    ...
    */
    ...
    function XoopsUser($id = null)
    {
        ...
        $this->initVar('user_avatar', XOBJ_DTYPE_TXTBOX, "", false, 30);
    ...
    */
    ...
    function isAdmin( $module_id = null ) {
        ...
        if (is_null($this->_isAdmin) || !isset($this->_isAdmin[$module_id])) {
            ...
            $this->_isAdmin[$module_id] = $moduleperm_handler->checkRight('module_admin', $module_id, $this->getGroups());
        }
