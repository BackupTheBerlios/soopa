<?php
// $Id: theme.php,v 1.2 2005/08/05 03:41:05 mauriciodelima Exp $
/**
   ...
   **/
    ...
    */
    function display( $contentTemplate = null, $pageTpl = null, $customVars = null ) {
        ...
        if ( !empty( $contentTemplate ) ) {
            ...
            $content .= $this->tplEngine->fetch( $contentTemplate );
        }
    ...
    **/
    ...
    function getCachedTemplateId() {
        ...
        return 'mod_'.$GLOBALS['xoopsModule']->getVar('dirname').'|'.md5(str_replace(XOOPS_URL, '', $protocol."://".$_SERVER['HTTP_HOST'].$GLOBALS['xoopsRequestUri'].$cachegroup));
    }
