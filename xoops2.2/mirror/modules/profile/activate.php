<?php
// $Id: activate.php,v 1.3 2005/08/08 23:43:18 mauriciodelima Exp $
//  ------------------------------------------------------------------------ //
...
if (isset($_REQUEST['op']) && $_REQUEST['op'] == "actv") {
    ...
    if ($thisuser->getVar('actkey') != $actkey) {
        redirect_header(XOOPS_URL.'/index.php',5,_US_ACTKEYNOT);
    } else {
        if ($thisuser->getVar('level') > 0 ) {
            redirect_header(XOOPS_URL.'/user.php',5,_US_ACONTACT);
        } else {
