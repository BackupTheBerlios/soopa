...
define("_INSTALL_REGUSERSD","Grupo de usuários cadastrados no site");
define("_INSTALL_ANONUSERS","Visitante");
...
Ao clicar em registrar, você estará concordando com este termo de responsabilidade.");
?>
