...
define("_AM_MODULECANT","Este bloco não pode ser excluido. Se você deseja fazer isso, desative o módulo.");
define("_AM_RUSUREDEL","Excluir o módulo <b>%s</b>?");
...
define('_AM_NOTSELNG', "'%s' não está selecionado."); // error message
